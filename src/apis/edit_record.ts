...
export default async function edit_record(tables: Tables, record_id: number, user_id?: number, files?: Array<File>, files_names_to_keep?: Array<string>, folder?: string){
