                        ...
                        {products_arr_display.map((product: Product) => 
                            <tr key={product.products[0].id}>
                                ...
                                <td>
                                    ...
                                    <img alt={product.products[0].product_name} src={"./products/" + product.products[0].id + "/" + product.products[0].url} width={"100px"} height={"100px"}></img>
                                    <img alt={product.products[0].product_name} src={"/app/image_storage/products/" + product.products[0].id + "/" + product.products[0].url} width={"100px"} height={"100px"}></img>
                                    <img alt={product.products[0].product_name} src={"./app/image_storage/products/" + product.products[0].id + "/" + product.products[0].url} width={"100px"} height={"100px"}></img>

                                    <img alt={product.products[0].product_name} src={process.env.REACT_APP_SECRET_SERVER_URL + "/image_storage/" + "products/" + product.products[0].id + "/" + product.products[0].url} width={"100px"} height={"100px"}></img>
                                    <img alt={product.products[0].product_name} src={process.env.REACT_APP_SECRET_SERVER_URL + "./image_storage/" + "products/" + product.products[0].id + "/" + product.products[0].url} width={"100px"} height={"100px"}></img>
