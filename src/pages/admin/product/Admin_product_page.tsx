                    ...
                    <table>
                        ...
                        {products_arr_display.map((product: Product) => 
                            <tr key={product.products[0].id}>
                                ...
                                <td>
                                    <img alt={product.products[0].product_name} src={"https://joynda.com/" + "image_storage/" + "products/" + product.products[0].id + "/" + product.products[0].url} width={"100px"} height={"100px"}></img>
                                </td>
