        ...
        <>
            <div key={product.products[0].id.toString()} className="grid-item">
                <Link to={"/item-info/" + product.products[0].id} state={{product_data: product}}>
                    ...
                    <img alt={product.products[0].product_name} className="images" src={"/image_storage" + "/images/products/" + product.products[0].id + "/" + product.products[0].url} width={"100px"} height={"100px"}></img>
